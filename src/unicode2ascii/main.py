...
additional_unicode_to_ascii = {
    ...
    "Ƨ": "TONE2",  # LATIN CAPITAL LETTER TONE TWO
    "ƨ": "tone2",  # LATIN SMALL LETTER TONE TWO
    "Ƽ": "TONE5",  # LATIN CAPITAL LETTER TONE FIVE
    "ƽ": "tone5",  # LATIN SMALL LETTER TONE FIVE
    "Ƅ": "TONE6",  # LATIN CAPITAL LETTER TONE SIX
    "ƅ": "tone6",  # LATIN SMALL LETTER TONE SIX
